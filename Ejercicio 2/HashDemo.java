...
public class HashDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Se hara un registro de usuarios, los cuales tendran que birndar\nsu id, email y su nombre.\nQue accion desea realizar(Ingrese el n�mero):");
		do {
			System.out.println(
			...
			} else if (res != 1 || res != 2 || res != 3 || res != 4 || res != 5 || res != 6 || res != 7 || res != 8
					|| res != 9) {
				System.out.print("Esa opci�n no existe en el men�");
			}
			resp = pregunta("\nDesea utilizar alguna opcion del men� m�s:", sc);
		} while (resp != 'n');
	}
